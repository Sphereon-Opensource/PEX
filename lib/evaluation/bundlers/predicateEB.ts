...
export class PredicateEB extends EvaluationBundler<InputDescriptor[], unknown> {
  ...
  public getEvaluations(inputDescriptors: InputDescriptor[], p: unknown): Evaluation<InputDescriptor[], unknown>[] {
    return [...this.myEvaluations(inputDescriptors, p)];
  }

  private myEvaluations(d: InputDescriptor[], p: unknown): Evaluation<InputDescriptor[], unknown>[] {
    return [
