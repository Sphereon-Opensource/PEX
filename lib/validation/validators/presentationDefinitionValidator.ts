...
import {SubmissionRequirementValidations} from './submissionRequirementValidations'
...
export class PresentationDefinitionValidator {
    ...
    _validate(presentationDefinition: PresentationDefinition) {
        ...
        if (presentationDefinition.submission_requirements !== null) {
            new SubmissionRequirementValidations()._validate(presentationDefinition.submission_requirements);
