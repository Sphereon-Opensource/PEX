...
export class SubmissionRequirementVB extends ValidationBundler<SubmissionRequirement> {
  ...
  private getMyValidations(srInd: number, srs: SubmissionRequirement[]): Validation<unknown>[] {
    return [
      {
  ...
  private getSubValidations(srInd: number, srs: SubmissionRequirement[]): Validation<unknown>[] {
