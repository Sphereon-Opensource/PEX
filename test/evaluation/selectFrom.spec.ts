...
describe('selectFrom tests', () => {
  it('Evaluate submission requirements all from group A', () => {
    ...
    expect(evaluationClientWrapper.selectFrom(pdSchema, vpSimple.verifiableCredential, dids, LIMIT_DISCLOSURE_SIGNATURE_SUITES)).toEqual({
  ...
  it('Evaluate submission requirements max 1: (all from group A and 2 from group B)', () => {
    ...
    const evaluationClientWrapper: EvaluationClientWrapper = new EvaluationClientWrapper();
    const result = evaluationClientWrapper.selectFrom(pdSchema, vpSimple.verifiableCredential, dids, LIMIT_DISCLOSURE_SIGNATURE_SUITES);
  ...
  it('Evaluate case without presentation submission', () => {
    ...
    const evaluationClientWrapper: EvaluationClientWrapper = new EvaluationClientWrapper();
    const result = evaluationClientWrapper.selectFrom(pdSchema, [vc], ['FAsYneKJhWBP2n5E21ZzdY'], LIMIT_DISCLOSURE_SIGNATURE_SUITES);
