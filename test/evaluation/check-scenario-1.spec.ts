...
describe('1st scenario', () => {
  ...
  it('should return ok get the right presentationSubmission', function () {
     ...
     */
    const selectFromResult = pex.selectFrom(pd, holderWallet.verifiableCredentials, [holderWallet.holder], LIMIT_DISCLOSURE_SIGNATURE_SUITES);
     ...
     */
    const presentation: IPresentation = pex.presentationFrom(pd, [holderWallet.verifiableCredentials[2]], 'did:didMethod:2021112400');
